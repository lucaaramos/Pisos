        ...
        >
          {productos.map((p) => (
            <Link
              key={p.id}
              to={`/producto/${p.id}`}
              className="min-w-[320px] max-w-sm bg-white rounded-3xl shadow-xl hover:shadow-2xl transition duration-300 transform hover:-translate-y-1 border border-gray-100 block"
            >
              <div className="relative">
                <img
                  src={p.imagen}
